...
namespace Line.Services.Seo
{
    public static class SeoExtensions
    {
        ...
        {
            bool ConvertNonWesternChars = true;
            bool AllowUnicodeCharsInUrls = false;
            //var seoSettings = EngineContext.Current.Resolve<SeoSettings>();
            return GetSeName(name, ConvertNonWesternChars,AllowUnicodeCharsInUrls);
        }
